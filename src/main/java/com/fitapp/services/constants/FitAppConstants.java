package com.fitapp.services.constants;

public class FitAppConstants {

	public static final String NUMBER_NOT_FOUND = "Your number is not registered with us.";
	...
	public static final String CLIENT_ALREADY_PRESENT = "Client already present";
